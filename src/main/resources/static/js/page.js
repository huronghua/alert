/**
 * Created by MiracleXu on 2017/9/11.
 */
(function($, window, document, undefined) {
    ...
    Paging.prototype = {
        ...
        creatHtml: function() {
            var me = this;
            var content = "";
            var current = me.options.pageNo;//当前页
            var total = me.options.totalPage;//总页数
            var totalNum = me.options.totalSize;//总行数
            ...
            if(total > 6) {
                ...
                if(parseInt(current) < 5) {
                    ...
                    //判断页码在末尾的时候
                    if(parseInt(current) < total - 3) {
                        for(var i = parseInt(current) - 2; i < parseInt(current) + 3; i++) {
                            if(parseInt(current) == i) {
                                content += "<a class='current'>" + i + "</a>";
                            } else {
                                content += "<a>" + i + "</a>";
